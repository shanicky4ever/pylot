...
class PertrubPylotPerceptionENV(gym.Env):
    def __init__(self):
        super(PertrubPylotPerceptionENV, self).__init__()
    ...
    def _create_dataflow(self):
        ...
        self.notify_streams.append(notify_rgb_stream)
        ...
        if FLAGS.obstacle_location_finder_sensor == 'lidar':
            ...
            self.notify_streams.append(notify_lidar_stream)
        elif FLAGS.obstacle_location_finder_sensor == 'depth_camera':
            depth_stream = depth_camera_stream
            self.notify_streams.append(notify_depth_stream)
            ...
            self.notify_streams.append(notify_left_camera_stream)
            self.notify_streams.append(notify_right_camera_stream)
        else:
            raise ValueError(
        ...
        if notify_prediction_stream:
            self.notify_streams.append(notify_prediction_stream)
